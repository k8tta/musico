...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { album: @music.album, genre: @music.genre, jacket: @music.jacket, publish: @music.publish, published: @music.published, title: @music.title, youtube: @music.youtube }
    end
  ...
  test "should update music" do
    patch :update, id: @music, music: { album: @music.album, genre: @music.genre, jacket: @music.jacket, publish: @music.publish, published: @music.published, title: @music.title, youtube: @music.youtube }
    assert_redirected_to music_path(assigns(:music))
  end
