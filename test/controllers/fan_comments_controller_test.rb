...
class FanCommentsControllerTest < ActionController::TestCase
  ...
  test "should create fan_comment" do
    assert_difference('FanComment.count') do
      post :create, fan_comment: { artist_no: @fan_comment.artist_no, body: @fan_comment.body, deleted: @fan_comment.deleted, name: @fan_comment.name }
    end
  ...
  test "should update fan_comment" do
    patch :update, id: @fan_comment, fan_comment: { artist_no: @fan_comment.artist_no, body: @fan_comment.body, deleted: @fan_comment.deleted, name: @fan_comment.name }
    assert_redirected_to fan_comment_path(assigns(:fan_comment))
  end
